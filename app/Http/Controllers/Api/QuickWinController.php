    ...
    public function login(Request $request)
    {
        if ($request->method() == 'POST')
        {
            ...
            if ($exists) {
                ...
                $remember_token_win = makeRandStr(20);
                User::query()->where('id', $user->id)->update(['ssruuid' => $ssruuid, 'remember_token_win' => $remember_token_win, 'last_login' => time()]);
    ...
    public function quick(Request $request)
    {
        if ($request->method() == 'POST')
        {
            ...
            if ($exists) {
                ...
                // 更新登录信息
                $remember_token_win = makeRandStr(20);
                User::query()->where('id', $user->id)->update(['remember_token_win' => $remember_token_win, 'last_login' => time()]);
...
//                $account_status = 0;
            ...
            $user->remember_token_win = makeRandStr(20);
            $user->save();
    ...
    public function setAccount(Request $request)
    {
        if ($request->method() == 'POST') {
            ...
            if (!$user->remember_token_win || $user->remember_token_win != $token) {
