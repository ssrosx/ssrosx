...
class UserController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $user->unusedTransfer = flowAutoShow($user->transfer_enable- $user->u - $user->d);
    ...
    public function addTicket(Request $request)
    {
        ...
        if ($obj->id) {
            ...
            return Response::json(['status' => 'success', 'data' => '', 'message' => 'Submit success']);
        } else {
            return Response::json(['status' => 'fail', 'data' => '', 'message' => 'Operation failed']);
        }
    }
    ...
    public function closeTicket(Request $request)
    {
        ...
        if ($ret) {
            ...
            return Response::json(['status' => 'fail', 'data' => '', 'message' => 'Close failed']);
        }
    }
            ...
            try {
                ...
                if ($goods->type == 2) {
                    ...
                    if ($user->expire_time < date('Y-m-d H:i:s')) {
                        ...
                        $expireTime = date('Y-m-d H:i:s', strtotime("+" . $goods->days . " days", strtotime($user->expire_time)));
                    }
